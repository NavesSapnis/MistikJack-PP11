...
{//хуй
    internal class Troll : MistikCreature
    {
        ...
        public Troll(string name, int age, int healPts, int damage, int luck, string baseTalent, string ultiTalent, int armor) : base(name, age, healPts, damage, luck, baseTalent, ultiTalent)
        {
